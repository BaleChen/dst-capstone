...
from dataset_utils import (
    ...
    make_supervised_data_module_unlikelihood,
) # Bale Chen
...
from unlikelihood_llama import LlamaWithUnlikelihoodLoss
...
def train():
    ...
    model = LlamaWithUnlikelihoodLoss.from_pretrained(
    ...
    model.unlikely_coef = training_args.unlikely_coef
    ...
    if training_args.output_dir == "./checkpoints":
        ...
        training_args.run_name += "_unlikelihood"
    ...
    data_module = make_supervised_data_module_unlikelihood(tokenizer=tokenizer, data_args=data_args)
    trainer = Trainer(
